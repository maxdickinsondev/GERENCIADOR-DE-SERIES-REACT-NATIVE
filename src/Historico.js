        ...
        return(
            <View style={styles.body}>
                ...
                <View style={styles.positioButton}>
                    <TouchableOpacity onPress={this.remover} style={styles.botaoImage}>
                        <Image source={require('../images/quit.png')} style={styles.addSerie}/>
                    </TouchableOpacity>
                </View>
...
class ListaSerie extends Component{
    ...
    render(){
        return(
            <View underlayColor='#434040' style={styles.seriesItem}>
